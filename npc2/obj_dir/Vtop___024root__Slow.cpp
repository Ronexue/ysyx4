...
void Vtop___024root____Vdpiimwrap_top__DOT__ID_Stage0__DOT__Registers0__DOT__set_gpr_ptr__Vdpioc2_TOP(const VlUnpacked<QData/*63:0*/, 32> &a);
...
void Vtop___024root___initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    Vtop___024root____Vdpiimwrap_top__DOT__ID_Stage0__DOT__Registers0__DOT__set_gpr_ptr__Vdpioc2_TOP(vlSelf->top__DOT__ID_Stage0__DOT__Registers0__DOT__rf);
}
...
void Vtop___024root___settle__TOP__4(Vtop___024root* vlSelf) {
    ...
    VL_EXTEND_WQ(65,64, __Vtemp3, vlSelf->top__DOT__EX_Stage0__DOT__ALU_src1);
    VL_EXTEND_WQ(65,64, __Vtemp4, vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__Adder_src2);
    VL_ADD_W(3, __Vtemp5, __Vtemp3, __Vtemp4);
    VL_EXTEND_WI(65,1, __Vtemp6, (IData)(vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__SUBctr));
    VL_ADD_W(3, __Vtemp7, __Vtemp5, __Vtemp6);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__sltu_Flag 
        = (1U & (((1U & __Vtemp7[2U]) ^ (IData)(vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__SUBctr)) 
                 ^ (IData)(vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__SUBctr)));
    VL_EXTEND_WI(65,1, __Vtemp9, (IData)(vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__SUBctr));
...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__offset2 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IFID_ID_pc = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IFID_ID_instr = VL_RAND_RESET_I(32);
    vlSelf->top__DOT__ID_IDEX_MemtoReg = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__ID_IDEX_MUXStore = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__ID_IDEX_Branch = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__ID_IDEX_ALUctr = VL_RAND_RESET_I(6);
    vlSelf->top__DOT__ID_IDEX_ALUBSrc = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__IDEX_EX_pc = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IDEX_EX_busA = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IDEX_EX_busB = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IDEX_EX_imm = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IDEX_EX_rd = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__IDEX_EX_MemtoReg = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__IDEX_EX_MUXStore = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__IDEX_EX_MemWr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IDEX_EX_Jump = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IDEX_EX_Branch = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__IDEX_EX_jalrctr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__IDEX_EX_ALUctr = VL_RAND_RESET_I(6);
    vlSelf->top__DOT__IDEX_EX_ALUBSrc = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__IDEX_EX_ALUASrc = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EXM_M_Zero = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EXM_M_ALUout = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EXM_M_busB = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EXM_M_rd = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__EXM_M_MemtoReg = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__EXM_M_MUXStore = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__EXM_M_MemWr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EXM_M_Jump = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EXM_M_Branch = VL_RAND_RESET_I(2);
    vlSelf->top__DOT__MWB_WB_Dataout = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__MWB_WB_ALUout = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__MWB_WB_rd = VL_RAND_RESET_I(5);
    vlSelf->top__DOT__MWB_WB_MemtoReg = VL_RAND_RESET_I(3);
    vlSelf->top__DOT__IF_Stage0__DOT__pc_next = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__IF_Stage0__DOT__pc_now = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__ID_Stage0__DOT__ExtOp = VL_RAND_RESET_I(3);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->top__DOT__ID_Stage0__DOT__Registers0__DOT__rf[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__Rtype = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__ItypeALU = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__lui = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__auipc = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__Load = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__Store = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__Btype = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__jal = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__ID_Stage0__DOT__Control0__DOT__jalr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU_src1 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU_src2 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__SUBctr = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__OPctr = VL_RAND_RESET_I(4);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__Adder_src2 = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__Add_Result = VL_RAND_RESET_Q(64);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__slt_Flag = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__sltu_Flag = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__slt_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__sltu_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__bge_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__bgeu_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__and_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__sll_result = VL_RAND_RESET_I(1);
    vlSelf->top__DOT__EX_Stage0__DOT__ALU0__DOT__ALUctr0__DOT__srl_result = VL_RAND_RESET_I(1);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->top__DOT__M_Stage0__DOT__DataMemory0__DOT__mem[__Vi0] = VL_RAND_RESET_Q(64);
    }
    vlSelf->__Vdlyvdim0__top__DOT__M_Stage0__DOT__DataMemory0__DOT__mem__v0 = 0;
    vlSelf->__Vdlyvval__top__DOT__M_Stage0__DOT__DataMemory0__DOT__mem__v0 = VL_RAND_RESET_Q(64);
    vlSelf->__Vdlyvset__top__DOT__M_Stage0__DOT__DataMemory0__DOT__mem__v0 = 0;
    vlSelf->__Vdlyvset__top__DOT__M_Stage0__DOT__DataMemory0__DOT__mem__v1 = 0;
